...
podman run --rm \
       ...
       "$IMAGE_NAME" bash -c "export PATH=\$PATH:/opt/rum && ls \"$HOME/.wineAffinity/drive_c/Program Files/Affinity/Designer 2/Designer.exe\" && rum ElementalWarrior-8.14 $HOME/.wineAffinity winetricks renderer=gl && rum ElementalWarrior-8.14 $HOME/.wineAffinity wine \"$HOME/.wineAffinity/drive_c/Program Files/Affinity/Designer 2/Designer.exe\"" bash "$@"
